...
<body>
    ...
    <div style="width: 940px;margin: 0 auto">
        ...
        <h3 style="display: inline;vertical-align: bottom;margin-left: 170px;font-size: 25px;color: #C55A11">Metabolites - ${drugName}</h3>
        <hr>
    </div>
    ...
    <script>
        $("#dgItems").datagrid({
            ...
            columns:[[
                ...
                {field:'drugType',title:'Type',width:100}
            ]],
